...
public class SFDC_TC29 extends BrowserUtility{
	...
	public static void main(String[] args) throws Exception {
		...
		waitForPageElementToBeVisible(driver.findElement(By.xpath("//a[contains(text(),'xyz')]")));
		driver.findElement(By.xpath("//a[contains(text(),'xyz')]")).click();
		
		System.out.println("Contact Details displayed");
		System.out.println();
