...
public class SFDC_TC31 extends BrowserUtility{
	...
	public static void main(String[] args) throws Exception {
		...
		driver.findElement(By.xpath("//input[@id='fname']")).sendKeys(row2.getCell(0).getStringCellValue());
		...
		waitForPageElementToBeVisible(driver.findElement(By.xpath("//div[@class='pbHeader']//input[@name='cancel']")));
		driver.findElement(By.xpath("//div[@class='pbHeader']//input[@name='cancel']")).click();
		
		Thread.sleep(5000);
		
		System.out.println("TestCase 31 Executed");
